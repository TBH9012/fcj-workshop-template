...
* Connect and get acquainted with the rules of First Cloud AI Journey.
* Understand basic AWS services and how to use the console & CLI.
* Create a Console account and complete tasks to receive $200 free credit.

### Tasks to be carried out this week:
| Day | Task                                                                                                                                                        | Start Date   | Completion Date | Reference Material                        |
| --- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ | --------------- | ----------------------------------------- |
| 2   | Attend the meeting on rules and professional conduct to prepare for the internship, get acquainted with the company environment, and gain an overview to build the workspace. | 20/04/2026   | 20/04/2026      |                                           |
| 3-6 | Create an AWS Free Tier 2025 account (applying the new policy to receive $200 credit) & get familiar with AWS Console/CLI.                                  | 21/04/2026   | 24/04/2026      | <https://000001.awsstudygroup.com/vi/> |
